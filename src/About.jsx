    ...
    return (
        <div>
            <div className="overflow-hidden">
                <div className="container-fluid color py-1">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6 col-12 slide-right">
                            <h1 className="m-3 text-white ">About Us</h1>
                            <p className="m-3 ">
                ...
                <div className="container-fluid  slide-right back ">
                    <div className="row align-items-center ">
                    ...
                    <div className='d-flex row g-4 overflow-hidden justify-content-center'>
                        ...
                        <div className="col-lg-2 col-md-2 col-12">
                            <div className='card'>
                                <div className="card-body">
                                    <img width={"230px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScMFTFjYCu6HWnfspcstISJx39q5Ur1F936Q&s" alt="" />                                        
                                    <h4>Lara </h4>
                                    <p className="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique, sit.</p>
